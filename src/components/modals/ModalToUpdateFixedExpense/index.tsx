...
import styles from './modalToUpdateFixedExpense.module.scss'
...
export default function ModalToUpdateFixedExpense({
  handleFunction,
  setFunction,
  monthId,
  selectedId,
  ...
  const { handleSubmit, control } = useForm<FormValues>({});
    const onSubmit = async (data: FormValues) => {
      console.log(data);
      mutation.mutate({_id: selectedId, updatedData: {title: data.title, category: 'charges fixes', date: data.date, amount: data.amount, month: monthId} })
      setTimeout(() => {
